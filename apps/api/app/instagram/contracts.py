...
class ReasonCode(StrEnum):
    ...
    FULL_DECODE_FAILED = "FULL_DECODE_FAILED"
    INCOMPATIBLE_OUTPUT = "INCOMPATIBLE_OUTPUT"
    MINIO_TRANSIENT_FAILURE = "MINIO_TRANSIENT_FAILURE"
    FINAL_OBJECT_CONFLICT = "FINAL_OBJECT_CONFLICT"
    POSTGRES_COMMIT_FAILURE = "POSTGRES_COMMIT_FAILURE"

...
$env:MINIO_ACCESS_KEY = $values['MINIO_ACCESS_KEY']; $env:MINIO_SECRET_KEY = $values['MINIO_SECRET_KEY']; $env:VIDEO_CURSOR_SECRET = $values['VIDEO_CURSOR_SECRET']
$env:COLLECTOR_ENABLED = 'true'; $env:COLLECTOR_HEADLESS = 'false'; $env:COLLECTOR_MAXIMUM_TARGET_COUNT = '10'
$env:COLLECTOR_MAXIMUM_REEL_BYTES = '104857600'; $env:COLLECTOR_MAXIMUM_RUN_BYTES = '734003200'; $env:COLLECTOR_MAXIMUM_SCROLL_ATTEMPTS = '58'
$env:COLLECTOR_TRANSITION_POLLING_SECONDS = '0.25'; $env:COLLECTOR_TRANSITION_TIMEOUT_SECONDS = '10'; $env:COLLECTOR_COOLDOWN_SECONDS = '0.5'; $env:COLLECTOR_OPERATOR_DEADLINE_SECONDS = '3600'
...
uv --directory apps/api run --extra collector python -m app.scripts.run_instagram_collector_stage3c1 --desired-total 10
exit $LASTEXITCODE
